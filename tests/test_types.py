...
from TelegramBotAPI.types.compound import Message, User, GroupChat, ReplyKeyboardMarkup, UserProfilePhotos, ReplyKeyboardHide, Location
...
class Methods(TestCase):
    ...
    def test_variable_type_assign(self):
        ...
        self.assertEqual(type(m.chat), GroupChat)
    ...
    def test_input_file(self):
        ...
        self.assertEqual('contentcontentcontentcontent', f._to_raw())
    ...
    def test_input_file_integration(self):
        ...
        self.assertEquals({'audio': 'lalalalalalalalalala'}, m._to_raw(strict=False))
